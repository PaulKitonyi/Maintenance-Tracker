...
class MaintenanceTrackerTestCase(unittest.TestCase):
    ...
    def test_api_can_create_request(self):
        """Test POST request"""
        res = self.client.post('/api/v1/users/requests', data=json.dumps(self.request), content_type='application/json')
    ...
    def test_api_can_edit_request(self):
        """Test PUT request"""
        self.client.post('/api/v1/users/requests', data=json.dumps(self.request), content_type='application/json')
        res = self.client.put('/api/v1/users/requests/1', data=json.dumps(self.request), content_type='application/json')
        self.assertEqual(res.status_code, 200)

    def test_api_can_delete_request(self):
        """Test DELETE request"""
        res = self.client.delete('/api/v1/users/requests/1',content_type='application/json')
        self.assertEqual(res.status_code, 200)
